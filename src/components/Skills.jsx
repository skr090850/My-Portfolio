            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 max-w-5xl mx-auto">
                    {skillsData.map((skill, index) => (
                        <div 
                            key={index} 
                            className="bg-slate-700/50 p-6 rounded-lg flex flex-col items-center justify-center gap-4 text-center text-white border border-slate-700 hover:border-cyan-400 hover:bg-slate-700 transition-all duration-300 transform hover:-translate-y-2"
                        >
